...
## Make Plot 4 - Plot type "l" 
        png("plot4.png", width = 480, height = 480)
        par(mfrow=c(2,2))

        ## First Graph
                plot(Dataset2$DateTime,Dataset2$Global_active_power, type="l", ylab="Global Active Power", xlab="")
        ## Second Graph
                with(Dataset2, plot(DateTime,Voltage, type="l"))
        ## Third Graph
        ...
        ## Fourth Graph
                with(Dataset2, plot(DateTime,Global_reactive_power, type="l"))
